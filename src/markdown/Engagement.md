...
After the introductory discussion and a safety briefing, students performed basic tasks and aseptic techniques. They SHAD students learned how to properly operate a micropipette and how to streak an agar plate using _E.coli_ with reporter proteins, all while maintaining an uncontaminated workspace using aseptic technique. They each created a design and the next day (after overnight incubation) the SHADs got to see their ideas come to life. Following the interactive laboratory section, students were guided through one of the labs of our iGEM team to observe different workspaces and tools that they might be able to use one day, should they continue to pursue the path of a synthetic biologist.
## **Day 2: Miniprep and GMOs**
The students began with a quick discussion on mobile genetic elements as an introduction to the day’s experiment. Working with members of Waterloo iGEM, the students were guided through the steps of mini-prepping _E.coli_ :pelleting of cells from a culture, lysing the cells to make the DNA accessible, then isolating the DNA from other cellular debris. For our experimental protocols see our [_Experiments Page_] (<http://2017.igem.org/Team:Waterloo/Experiments>).
...
We began the final day of our workshop by going over the process of gel electrophoresis and the significance of the results. Students then practiced loading the samples into the gel before fully running the gels; they were imaged and showed to the students.
...
## **Gallery**
|![ERROR]({{image "DSC0577.JPG" "directlink" mode}})|![ERROR]({{image "DSC0586.JPG" "directlink" mode}})|![ERROR]({{image "DSC0463.JPG" "directlink" mode}})|
|:----:|:----:|:----:|
|![ERROR]({{image "DSC0462.JPG" "directlink" mode}})|![ERROR]({{image "20170727141430.jpg" "directlink" mode}})|![ERROR]({{image "DSC0889.JPG" "directlink" mode}})|
|![ERROR]({{image "DSC0847.JPG" "directlink" mode}})|![ERROR]({{image "DSC0804.JPG" "directlink" mode}})|![ERROR]({{image "DSC0670.JPG" "directlink" mode}})|
|![ERROR]({{image "DSC0667.JPG" "directlink" mode}})|![ERROR]({{image "DSC0653.JPG" "directlink" mode}})|![ERROR]({{image "DSC0642.JPG" "directlink" mode}})|
![ERROR]({{image "DSC0639.JPG" "directlink" mode}})|![ERROR]({{image "DSC0596.JPG" "directlink" mode}})|![ERROR]({{image "DSC0500.JPG" "directlink" mode}})|
...
<center>![Simulated tube]({{image "Simulated tube.png" "directlink" mode}})</center>
