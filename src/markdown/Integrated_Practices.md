...
### Testing Snake35
	...
	During the Waterloo Faculty of Science Open House, our booth had a table where we displayed and presented Snake35. Kids got the chance to play the game and learn about the foundational concepts of FRET. Our game received lots of positive feedback from kids and parents alike, and they demonstrated a foundational understanding of our project. This helped us confirm that that our game was an effective tool in conveying information about our project! We also felt that the game captivated the interests of the kids in a way that they were willing to listen to and discuss our project. We also received useful feedback for the game itself, including that the speed of the game was quite fast for younger players. For the final iteration of the game, we decreased the speed of the snake.
...
One of our team members with 3D modelling experience ran a quick workshop on how to use CAD software for other team members to attend. Learning how to use AutoCAD under the tutelage of a peer was a fun activity and helped the team grow together. While working in a spatial simulated environment poses its challenges, it becomes relatively easy to use after some practice. After a couple hours of work together, the ability to perform basic operations and the knowledge of some useful tricks were gained. Further hours of individual practice allowed for the creation of quality schematics. This knowledge was used by the team members to produce gel combs of varying sizes and dimensions, as well as experimental test tube rack designs, and assist with other designs used in the catalogue.
...
Please visit our official Waterloo iGEM page to view our catalogue seen [here](hyperlink goes between these brackets and you will click on the word here).
